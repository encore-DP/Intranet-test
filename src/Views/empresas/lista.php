                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                            <div class="flex-grow-1">
                                <h4 class="fs-18 fw-semibold m-0">Lista de Empresas</h4>
                            </div>
                                                    ...
                                                    <?php if (!empty($empresas)): ?>
                                                        <?php foreach ($empresas as $row): ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <span><?= htmlspecialchars($row['RUC']) ?></span>
                                                                </td>
                                                                <td class="text-end d-flex justify-content-end gap-1">
                                                        
                                                                    <!-- Editar (GET) -->
                                                                    <a href="/empresas/<?= (int)$row['empresa_id'] ?>/editar"
                                                                    ...
                                                                    <!-- Eliminar (POST) -->
                                                                    <form method="post"
                                                                          action="/empresas/<?= (int)$row['empresa_id'] ?>/eliminar"
